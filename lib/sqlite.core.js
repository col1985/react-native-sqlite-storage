...
// SQLitePlugin.prototype.runMethod = function() {
//   if (!this.openDBs[this.dbname]) {
//     error(newSQLError('database not open'));
//     return;
//   }

//   plugin.exec("runMethod", {} ,opensuccesscb, openerrorcb);
// };
...
SQLitePluginTransaction.prototype.runMethod = function(sql, values, success, error) {
  var that = this;
  ...
  // that.addStatement(sql, values, success, error);

  // plugin.exec("runMethod", { sql, values } ,success, error);
};
